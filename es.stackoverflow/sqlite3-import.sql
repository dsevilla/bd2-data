...
CREATE TABLE Posts (
    Id INT,
    AcceptedAnswerId INT NULL DEFAULT NULL REFERENCES Posts(Id),
    ...
    LastEditorUserId INT NULL DEFAULT NULL REFERENCES Users(Id),
    OwnerDisplayName TEXT DEFAULT NULL,
    OwnerUserId INT NULL DEFAULT NULL REFERENCES Users(Id),
    ParentId INT NULL DEFAULT NULL REFERENCES Posts(Id),
...
CREATE TABLE Tags (
    Id INT,
    Count INT DEFAULT 0,
    ExcerptPostId INT NULL DEFAULT NULL REFERENCES Posts(Id),
    TagName TEXT,
    WikiPostId INT NULL DEFAULT NULL REFERENCES Posts(Id),
    PRIMARY KEY(Id)
);
...
CREATE TABLE Comments (
    ...
    ContentLicense TEXT NULL DEFAULT NULL,
    CreationDate DATETIME(6) NULL DEFAULT NULL,
    PostId INT NULL DEFAULT NULL REFERENCES Posts(Id),
    Score INT DEFAULT 0,
    Text TEXT,
    UserDisplayName TEXT,
    UserId INT NULL DEFAULT NULL REFERENCES Users(Id),
    PRIMARY KEY(Id)
);
